...
namespace P_7Transportadora.Formularios
{
	partial class FormEmbalagens
	{
		...
		private void InitializeComponent()
		{
			...
			this.txt_IdEmbalagem = new System.Windows.Forms.TextBox();
			...
			this.dgv_embalagem = new System.Windows.Forms.DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.dgv_embalagem)).BeginInit();
			this.SuspendLayout();
			// 
			// tabControl1
			// 
			...
			this.gb_dados.Controls.Add(this.txt_IdEmbalagem);
			this.gb_dados.Controls.Add(this.label3);
			this.gb_dados.Controls.Add(this.label4);
			this.gb_dados.Controls.Add(this.txt_Descricao);
			...
			// txt_IdEmbalagem
			// 
			this.txt_IdEmbalagem.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.txt_IdEmbalagem.Enabled = false;
			this.txt_IdEmbalagem.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txt_IdEmbalagem.Location = new System.Drawing.Point(112, 19);
			this.txt_IdEmbalagem.Name = "txt_IdEmbalagem";
			this.txt_IdEmbalagem.Size = new System.Drawing.Size(295, 20);
			this.txt_IdEmbalagem.TabIndex = 8;
			// 
			// label3
			// 
			...
			this.txt_Descricao.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txt_Descricao.Location = new System.Drawing.Point(112, 57);
			this.txt_Descricao.Name = "txt_Descricao";
			this.txt_Descricao.Size = new System.Drawing.Size(292, 20);
			this.txt_Descricao.TabIndex = 10;
			this.txt_Descricao.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Txt_NomeConteudoKeyDown);
			// 
			// panel1
			// 
			...
			this.superTabItem1.Text = "EMBALAGENS";
			// 
			// tab2
			// 
			...
			// 
			this.splitContainer1.Panel2.Controls.Add(this.dgv_embalagem);
			...
			this.groupBox1.Text = "DIGITE O NOME DA EMBALAGEM";
			// 
			// txt_localizar
			// 
			...
			// dgv_embalagem
			// 
			this.dgv_embalagem.AllowUserToAddRows = false;
			this.dgv_embalagem.AllowUserToOrderColumns = true;
			this.dgv_embalagem.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill;
			this.dgv_embalagem.Dock = System.Windows.Forms.DockStyle.Fill;
			this.dgv_embalagem.Location = new System.Drawing.Point(0, 0);
			this.dgv_embalagem.MultiSelect = false;
			this.dgv_embalagem.Name = "dgv_embalagem";
			this.dgv_embalagem.ReadOnly = true;
			this.dgv_embalagem.RowHeadersVisible = false;
			this.dgv_embalagem.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.dgv_embalagem.Size = new System.Drawing.Size(1018, 442);
			this.dgv_embalagem.TabIndex = 1;
			this.dgv_embalagem.KeyDown += new System.Windows.Forms.KeyEventHandler(this.dgv_embalagemKeyDown);
			// 
			// tab1
			// 
			...
			this.Name = "FormEmbalagens";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "CADASTRO DE EMBALAGENS";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Shown += new System.EventHandler(this.FormEmbalagensShown);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FormEmbalagensKeyDown);
			...
			((System.ComponentModel.ISupportInitialize)(this.dgv_embalagem)).EndInit();
		...
		private System.Windows.Forms.TextBox txt_IdEmbalagem;
		...
		private System.Windows.Forms.DataGridView dgv_embalagem;
