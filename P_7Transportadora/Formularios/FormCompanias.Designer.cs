...
namespace P_7Transportadora.Formularios
{
	partial class FormCompanias
	{
		...
		private void InitializeComponent()
		{
			...
			this.txt_IdCompania = new System.Windows.Forms.TextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.txt_NomeCompania = new System.Windows.Forms.TextBox();
			...
			this.dgv_companias = new System.Windows.Forms.DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.dgv_companias)).BeginInit();
			this.SuspendLayout();
			// 
			// tabControl1
			// 
			...
			this.gb_dados.Controls.Add(this.txt_IdCompania);
			this.gb_dados.Controls.Add(this.label3);
			this.gb_dados.Controls.Add(this.label4);
			this.gb_dados.Controls.Add(this.txt_NomeCompania);
			...
			// txt_IdCompania
			// 
			this.txt_IdCompania.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.txt_IdCompania.Enabled = false;
			this.txt_IdCompania.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txt_IdCompania.Location = new System.Drawing.Point(112, 19);
			this.txt_IdCompania.Name = "txt_IdCompania";
			this.txt_IdCompania.Size = new System.Drawing.Size(295, 20);
			this.txt_IdCompania.TabIndex = 8;
			// 
			// label3
			// 
			...
			this.label4.Text = "NOME COMPANIA";
			// 
			// txt_NomeCompania
			// 
			this.txt_NomeCompania.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.txt_NomeCompania.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
			this.txt_NomeCompania.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txt_NomeCompania.Location = new System.Drawing.Point(112, 57);
			this.txt_NomeCompania.Name = "txt_NomeCompania";
			this.txt_NomeCompania.Size = new System.Drawing.Size(292, 20);
			this.txt_NomeCompania.TabIndex = 10;
			this.txt_NomeCompania.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Txt_NomeCompaniaKeyDown);
			// 
			// panel1
			// 
			...
			this.superTabItem1.Text = "COMPANIAS";
			// 
			// tab2
			// 
			...
			// 
			this.splitContainer1.Panel2.Controls.Add(this.dgv_companias);
			...
			this.groupBox1.Text = "DIGITE O NOME DA COMPANIA";
			// 
			// txt_localizar
			// 
			...
			// dgv_companias
			// 
			this.dgv_companias.AllowUserToAddRows = false;
			this.dgv_companias.AllowUserToOrderColumns = true;
			this.dgv_companias.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill;
			this.dgv_companias.Dock = System.Windows.Forms.DockStyle.Fill;
			this.dgv_companias.Location = new System.Drawing.Point(0, 0);
			this.dgv_companias.MultiSelect = false;
			this.dgv_companias.Name = "dgv_companias";
			this.dgv_companias.ReadOnly = true;
			this.dgv_companias.RowHeadersVisible = false;
			this.dgv_companias.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.dgv_companias.Size = new System.Drawing.Size(1018, 442);
			this.dgv_companias.TabIndex = 1;
			this.dgv_companias.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Dgv_companiasKeyDown);
			// 
			// tab1
			// 
			...
			this.Name = "FormCompanias";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "CADASTRO DE COMPANIAS";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Shown += new System.EventHandler(this.FormCompaniasShown);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FormCompaniasKeyDown);
			...
			((System.ComponentModel.ISupportInitialize)(this.dgv_companias)).EndInit();
		...
		private System.Windows.Forms.TextBox txt_IdCompania;
		private System.Windows.Forms.Label label4;
		private System.Windows.Forms.TextBox txt_NomeCompania;
		...
		private System.Windows.Forms.DataGridView dgv_companias;
