...
CREATE TABLE `embalagens` (
  `idEmbalagen` int(11) NOT NULL AUTO_INCREMENT,
  `Descricao` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idEmbalagen`)
...
INSERT INTO `embalagens` VALUES (4,'CAIXA DE PAPELÃO'),(5,'CAIXA DE MADEIRA'),(6,'CAIXA DE MDF'),(7,'PAINEL DE ISOPOR'),(9,'PLASTICO BOLHA');
...
-- Dump completed on 2017-07-25  1:59:49
